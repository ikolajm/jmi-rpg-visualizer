...
import type { EquipmentCategory2014, EquipmentCategory2024, EquipmentCategory } from '../../databases/types/equipmentCategory.types.ts';
// ===
...
function write2014Data(dataArray14: EquipmentCategory2014[], dataArray24: EquipmentCategory2024[], processedData: EquipmentCategory[]): EquipmentCategory[] {
...
function write2024Data(dataArray24: EquipmentCategory2024[], processedData: EquipmentCategory[]): EquipmentCategory[] {
    dataArray24.forEach(ec24 => {
